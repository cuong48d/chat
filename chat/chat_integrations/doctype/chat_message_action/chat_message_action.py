...
class ChatMessageAction(Document):
	...
	if TYPE_CHECKING:
		...
		from chat.chat_integrations.doctype.chat_message_action_fields.chat_message_action_fields import (
			ChatMessageActionFields,
		)
		...
		enabled: DF.Check
		fields: DF.Table[ChatMessageActionFields]
