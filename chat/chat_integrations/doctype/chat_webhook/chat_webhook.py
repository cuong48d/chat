...
class ChatWebhook(Document):
	...
	def before_insert(self):
		...
		webhook = frappe.get_all("Chat Webhook", filters={"name": self.name})
		if webhook:
	...
	def get_doctype_and_event(self):
		doctypes_and_events = [
			...
			{"label": "Message Edited", "doctype": "Chat Message", "event": "on_update"},
			{"label": "Message Deleted", "doctype": "Chat Message", "event": "on_trash"},
			{"label": "Message Reacted On", "doctype": "Chat Message Reaction", "event": "after_insert"},
			{"label": "Channel Created", "doctype": "Chat Channel", "event": "after_insert"},
			{"label": "Channel Deleted", "doctype": "Chat Channel", "event": "on_trash"},
			{
			...
			{"label": "User Added", "doctype": "Chat User", "event": "after_insert"},
			{"label": "User Deleted", "doctype": "Chat User", "event": "on_trash"},
		]
