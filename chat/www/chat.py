...
def get_context(context):
	...
	if app_name and app_name != "Frappe":
		context["app_name"] = app_name + " | " + "Chat"

	else:
		context["app_name"] = "Chat"

	if frappe.session.user != "Guest":
		capture("active_site", "chat")

		context[
			"preload_links"
		] = """
			<link rel="preload" href="/api/method/frappe.auth.get_logged_user" as="fetch" crossorigin="use-credentials">
			<link rel="preload" href="/api/method/chat.api.workspaces.get_list" as="fetch" crossorigin="use-credentials">
			<link rel="preload" href="/api/method/chat.api.chat_users.get_list" as="fetch" crossorigin="use-credentials">
			<link rel="preload" href="/api/method/chat.api.chat_channel.get_all_channels?hide_archived=false" as="fetch" crossorigin="use-credentials">
			"""
	else:
