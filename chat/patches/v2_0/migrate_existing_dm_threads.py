...
def execute():
	...
	thread_channel = frappe.qb.DocType("Chat Channel")
	message = frappe.qb.DocType("Chat Message")
	message_channel = frappe.qb.DocType("Chat Channel")
	...
	for result in results:
		frappe.db.set_value("Chat Channel", result.name, {"is_dm_thread": 1, "workspace": None})
