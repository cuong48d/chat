...
from chat.api.chat_users import get_list
from chat.utils import get_channel_members as get_channel_members_util
from chat.utils import get_workspace_members
...
def get_channel_members(channel_id):
	...
	frappe.has_permission("Chat Channel", doc=channel_id, throw=True)
	...
	channel_type = frappe.get_cached_value("Chat Channel", channel_id, "type")

	if channel_type == "Open":
		workspace = frappe.get_cached_value("Chat Channel", channel_id, "workspace")
