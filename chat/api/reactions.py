...
from chat.utils import is_channel_member
...
def react(message_id: str, reaction: str, is_custom: bool = False, emoji_name: str = None):
	...
	channel_id = frappe.get_cached_value("Chat Message", message_id, "channel_id")
	...
	if existing_reaction:
		...
		frappe.get_doc("Chat Message Reaction", existing_reaction).delete(delete_permanently=True)
