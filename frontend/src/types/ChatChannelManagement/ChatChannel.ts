import { ChatPinnedMessages } from '../Chat/ChatPinnedMessages'
...
export interface ChatChannel{
	...
	/**	Pinned Messages : Table - Chat Pinned Messages	*/
	pinned_messages?: ChatPinnedMessages[]
