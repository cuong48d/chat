import { ChatAIFunctionParams } from './ChatAIFunctionParams'

export interface ChatAIFunction{
	creation: string
	name: string
	modified: string
	owner: string
	...
	/**	Strict : Check	*/
	strict?: 0 | 1
	/**	Parameters : Table - Chat AI Function Params	*/
	parameters?: ChatAIFunctionParams[]
	/**	Params : JSON	*/
	params?: any
